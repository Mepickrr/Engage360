...
export default function AskAiBar() {
  ...
  return (
    <section
      className="rounded-xl border border-border bg-surface p-4 shadow-[0_1px_4px_rgba(108,58,232,0.06)] bg-gradient-to-br from-white to-[#FAF8FF]"
      ...
      <div className="flex items-center gap-3">
        ...
        >
          <input
            ...
            className="flex-1 bg-transparent outline-none text-[14px] placeholder:text-text-muted py-1.5"
          />
          ...
          <button
            ...
            className="w-9 h-9 rounded-md bg-primary hover:bg-primary-hover text-white flex items-center justify-center transition-colors"
            aria-label="Send"
          >
