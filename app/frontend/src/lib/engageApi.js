...
export const createAgent = (body) => api.post("/agents", body);
export const updateAgent = (id, body) => api.put(`/agents/${id}`, body);
export const deleteAgent = (id) => api.del(`/agents/${id}`);
