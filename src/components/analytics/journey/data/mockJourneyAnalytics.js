...
export function getJourneyAnalytics(filters) {
  ...
  const overview = {
    ...
    activeAlerts: [
      { type: "template_paused", journeyId: "j8", message: "Mixpanel Flow for not ordered users is paused — template pending re-approval." },
