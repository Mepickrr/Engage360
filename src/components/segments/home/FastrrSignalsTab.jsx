...
const SUB_TABS = [
  ...
  { value: "shiprocket", label: "Fastrr Signals", badge: "New" },
];
...
export default function FastrrSignalsTab({ searchQuery }) {
  const [subTab, setSubTab] = useState("acquisition");
  const [visibleCount, setVisibleCount] = useState(SOURCE.acquisition.pageSize);
